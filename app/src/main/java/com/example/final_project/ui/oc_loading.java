...
public class oc_loading extends AppCompatActivity {
    ...
    private JoyImageGenerationService joyImageGenerationService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler = new Handler();
        joyImageGenerationService = new JoyImageGenerationService();
    ...
    private void generateImage(String prompt) {
        ...
        joyImageGenerationService.JoygenerateImage(this, prompt, new JoyImageGenerationService.ImageGenerationCallback() {
            @Override
            public void onSuccess(String characterName, String imagePath) {
                ...
                runOnUiThread(() -> {
                    ...
                    Intent intent = new Intent(oc_loading.this, joypal_chat.class);
                    intent.putExtra("imagePath", imagePath); // 传递生成的图片路径
                    intent.putExtra("characterName", characterName); // 传递角色名称
                    startActivity(intent);
